-- Re-apply columns from migration 20260212100000 which was marked applied but didn't execute
-- All statements use IF NOT EXISTS / EXCEPTION so they're safe to re-run

-- Business (Household) columns
